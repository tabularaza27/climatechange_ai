...
<div class='buttons' id='sticky-nav'>
  ...
  <a class='button' href='#key-highlights'>Key Highlights
...
* Please register [here](https://icml.cc/Register/view-registration) to get full benefits of the workshop (including the ability to attend poster sessions and ask questions during the live Q&A)
* We have an exciting array of keynote talks, panel discussions, spotlight talks and poster presentations. More information [here](#key-highlights).
***
...
## About the Workshop
 ...
 - Registration Portal: https://icml.cc/Register/view-registration
...
* Two panel discussions with thought leaders on:
