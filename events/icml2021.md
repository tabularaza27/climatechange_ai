...
* **Poster sessions:** Poster sessions and the end-of-day reception will take place in our online space on Gather.town. (Registration is required to attend.) Join links: <a href='https://eventhosts.gather.town/wCSIBOjTzAq2yNdA/tccml-poster-room' target='_blank'>Posters 1-22</a>, <a href='https://eventhosts.gather.town/zYeOOcanMeG1WPhZ/tccml-poster-room-2' target='_blank'>Posters 23-44</a>, <a href='https://eventhosts.gather.town/Uu8pYs0AErlwCkf7/tccml-poster-room-3' target='_blank'>Posters 45-66</a>, <a href='https://eventhosts.gather.town/iieMtBzGua1Di5uo/tccml-poster-room-4' target='_blank'>Posters 67-89</a>, <a href='https://tinyurl.com/CCAIICML2021-Poster-Session' target='_blank'>Lobby</a>.
...
## About the Workshop
 ...
 - Location: Virtual
 - Free Livestream Link: <a href="/icml2021_livestream" target="_blank">https://www.climatechange.ai/icml2021_livestream</a>
...
{% include workshop_schedule_table.html workshop="icml2021" %}

## Accepted Works

Works were submitted to one of two tracks: [Papers](#Papers) or [Proposals](#Proposals). 

Click the links below for information about each submission, including slides, videos, and papers. For poster sessions (registration required), you can join here: <a href='https://eventhosts.gather.town/wCSIBOjTzAq2yNdA/tccml-poster-room' target='_blank'>Posters 1-22</a>, <a href='https://eventhosts.gather.town/zYeOOcanMeG1WPhZ/tccml-poster-room-2' target='_blank'>Posters 23-44</a>, <a href='https://eventhosts.gather.town/Uu8pYs0AErlwCkf7/tccml-poster-room-3' target='_blank'>Posters 45-66</a>, <a href='https://eventhosts.gather.town/iieMtBzGua1Di5uo/tccml-poster-room-4' target='_blank'>Posters 67-89</a>, <a href='https://tinyurl.com/CCAIICML2021-Poster-Session' target='_blank'>Lobby</a>.
...
$(document).ready(function() {
  ...
  function localDate(s) {
    const parts = s.split(':');
    const dt = DateTime.utc(2021, 7, 23, parseInt(parts[0]), parseInt(parts[1]), 0, 0);
    return dt.setZone(tz).toFormat("H:mm");
  }

  for (let el of Array.from(document.getElementsByClassName('poster-session-time'))) {
    const dates = el.innerText.split('-');
    const localString = `${localDate(dates[0])}-${localDate(dates[1])} ${tzShort}`;
    el.innerHTML = `${el.innerText}<br>(${localString})`;
  }
});
</script>
